...
export class Env {
  ...
  static get password() {
    return this.getVal("M365_ACCOUNT_PASSWORD", process.env.M365_ACCOUNT_PASSWORD);
  }
  ...
  static get azureAccountPassword() {
    return this.getVal("AZURE_ACCOUNT_PASSWORD", process.env.AZURE_ACCOUNT_PASSWORD);
  }

  static get azureSubscriptionId() {
    return this.getVal("AZURE_SUBSCRIPTION_ID", process.env.AZURE_SUBSCRIPTION_ID);
  }

  static get azureSubscriptionName() {
    return this.getVal("AZURE_SUBSCRIPTION_NAME", process.env.AZURE_SUBSCRIPTION_NAME);
  }
