...
export const sampleProjectMap: Record<TemplateProject, TemplateProjectFolder> = {
  [TemplateProject.HelloWorldTabBackEnd]: TemplateProjectFolder.HelloWorldTabBackEnd,
  [TemplateProject.ContactExporter]: TemplateProjectFolder.ContactExporter,
  [TemplateProject.OneProductivityHub]: TemplateProjectFolder.OneProductivityHub,
  ...
  [TemplateProject.ProactiveMessaging]: TemplateProjectFolder.ProactiveMessaging,
  ...
  [TemplateProject.GraphConnectorBot]: TemplateProjectFolder.GraphConnectorBot,
};
...
export class Timeout {
  ...
  public static readonly playwrightBotConsentContinueButton: number = 2 * 60 * 1000;
...
export class TreeViewCommands {
  ...
  public static readonly BuildTeamsPackageCommand: string = "Zip Teams App Package";
...
export class CommandPaletteCommands {
  ...
  public static readonly CreateProjectCommand: string = "Teams: Create a New App";
  public static readonly ManifestValidateCommand: string = "Teams: Validate manifest file";
  public static readonly BuildTeamsPackageCommand: string = "Teams: Zip Teams App Package";
  ...
  public static readonly CreateEnvironmentCommand: string = "Teams: Create New Environment";
  public static readonly DeployAadAppManifestCommand: string =
    "Teams: Update Azure Active Directory App";
  public static readonly UpgradeProjectCommand: string = "Teams: Upgrade Project";
  public static readonly InstallTTK: string = "Extensions: Install Specific Version of Extension";
}
...
export class Notification {
  ...
  static readonly TaskError = "There are task errors. See the output for details.";
  ...
  static readonly UnresolvedPlaceholderError = "MissingEnvironmentVariablesError";
